...
<body>
	...
	<div class="user-content">
		...
		<div class="profile-edit">
			<form action="user-panel.php" method="post" class="edit-form">
				<div class="profile1">
				...
				<div class="profile1">
					...
					<div class="profile-inner">
						...
						<input type="text" value="<?php echo $mobileno; ?>" readonly class="profile-input">
					</div>
				</div>
				<div class="profile1">
					<div class="profile-inner">
				...
				<div class="profile1">
					<div class="profile-inner profile-btn">
						<a href="profile-edit.php">Update</a>
					</div>
				</div>
			</form>
		</div>
